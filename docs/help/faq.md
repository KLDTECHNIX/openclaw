---
summary: "Frequently asked questions about FreeClaw setup, configuration, and usage"
title: "FAQ"
---
...
- [Quick start and first-run setup]
  ...
  - [What's the recommended way to install and set up FreeClaw?](#whats-the-recommended-way-to-install-and-set-up-openclaw)
  ...
  - [I can't access docs.freeclaw.ai (SSL error). What now?](#i-cant-access-docsopenclawai-ssl-error-what-now)
  - [What's the difference between stable and beta?](#whats-the-difference-between-stable-and-beta)
  - [How do I install the beta version, and what's the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  - [How do I try the latest bits?](#how-do-i-try-the-latest-bits)
  - [How long does install and onboarding usually take?](#how-long-does-install-and-onboarding-usually-take)
  - [Installer stuck? How do I get more feedback?](#installer-stuck-how-do-i-get-more-feedback)
  - [Windows install says git not found or freeclaw not recognized](#windows-install-says-git-not-found-or-openclaw-not-recognized)
  - [The docs didn't answer my question - how do I get a better answer?](#the-docs-didnt-answer-my-question-how-do-i-get-a-better-answer)
  - [How do I install FreeClaw on Linux?](#how-do-i-install-openclaw-on-linux)
  - [How do I install FreeClaw on a VPS?](#how-do-i-install-openclaw-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask FreeClaw to update itself?](#can-i-ask-openclaw-to-update-itself)
  ...
  - [If I buy a Mac mini to run FreeClaw, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-openclaw-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different FreeClaw instances?](#can-multiple-people-use-one-whatsapp-number-with-different-openclaw-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What's the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run FreeClaw on a dedicated machine?](#how-important-is-it-to-run-openclaw-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run FreeClaw in a VM and what are the requirements](#can-i-run-openclaw-in-a-vm-and-what-are-the-requirements)
- [What is FreeClaw?](#what-is-openclaw)
  - [What is FreeClaw, in one paragraph?](#what-is-openclaw-in-one-paragraph)
  ...
  - [Can FreeClaw help with lead gen outreach ads and blogs for a SaaS](#can-openclaw-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can FreeClaw run tasks on a schedule or continuously in the background?](#can-openclaw-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with FreeClaw saved locally?](#is-all-data-used-with-openclaw-saved-locally)
  - [Where does FreeClaw store its data?](#where-does-openclaw-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What's the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall FreeClaw?](#how-do-i-completely-uninstall-openclaw)
...
- [Config basics](#config-basics)
  ...
  - [Can the FreeClaw browser run headless?](#can-the-openclaw-browser-run-headless)
...
- [Remote gateways and nodes](#remote-gateways-and-nodes)
  ...
  - [Can two FreeClaw instances talk to each other (local + VPS)?](#can-two-openclaw-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does FreeClaw load environment variables?](#how-does-openclaw-load-environment-variables)
...
- [Sessions and multiple chats](#sessions-and-multiple-chats)
  ...
  - [Is there a way to make a team of FreeClaw instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-openclaw-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset FreeClaw but keep it installed?](#how-do-i-completely-reset-openclaw-but-keep-it-installed)
  ...
  - [Why doesn't FreeClaw reply in a group?](#why-doesnt-openclaw-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do FreeClaw, Flawd, and Krill use for models?](#what-do-openclaw-flawd-and-krill-use-for-models)
...
- [Gateway: ports, "already running", and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [How do I run FreeClaw in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-openclaw-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart FreeClaw?](#i-closed-my-terminal-on-windows-how-do-i-restart-openclaw)
...
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose FreeClaw to inbound DMs?](#is-it-safe-to-expose-openclaw-to-inbound-dms)
...
7. **Gateway snapshot**
   ...
   freeclaw health --verbose   # shows the target URL + config path on errors
   ```
...
This installs FreeClaw **from a git checkout**, so the agent can read the code + docs and
...
[https://github.com/freeclaw/freeclaw/issues](https://github.com/freeclaw/freeclaw/issues)
[https://github.com/freeclaw/freeclaw/pulls](https://github.com/freeclaw/freeclaw/pulls)
...
If you don't have a global install yet, run it via `pnpm freeclaw onboard`.
...
- If it asks for auth, paste the token from `gateway.auth.token` (or `FREECLAW_GATEWAY_TOKEN`) into Control UI settings.
...
1. Install FreeClaw on the new machine.
2. Copy `$FREECLAW_STATE_DIR` (default: `~/.freeclaw`) from the old machine.
3. Copy your workspace (default: `~/.freeclaw/workspace`).
...
under `~/.freeclaw/` (for example `~/.freeclaw/agents/<agentId>/sessions/`).
...
[https://github.com/freeclaw/freeclaw/blob/main/CHANGELOG.md](https://github.com/freeclaw/freeclaw/blob/main/CHANGELOG.md)

Newest entries are at the top. If the top section is marked **Unreleased**, the next dated
section is the latest shipped version. Entries are grouped by **Highlights**, **Changes**, and
**Fixes** (plus docs/other sections when needed).

### I cant access docs.freeclaw.ai SSL error What now

Some Comcast/Xfinity connections incorrectly block `docs.freeclaw.ai` via Xfinity
Advanced Security. Disable it or allowlist `docs.freeclaw.ai`, then retry. More
...
[https://github.com/freeclaw/freeclaw/tree/main/docs](https://github.com/freeclaw/freeclaw/tree/main/docs)
...
[https://freeclaw.ai/install.ps1](https://freeclaw.ai/install.ps1)
...
### Windows install says git not found or freeclaw not recognized
...
**2) freeclaw is not recognized after install**
...
### How do I install FreeClaw on Linux
...
### How do I install FreeClaw on a VPS
...
### Can I ask FreeClaw to update itself
...
No. You can run FreeClaw with **API keys** (Anthropic/OpenAI/others) or with
...
Yes - via **setup-token**. FreeClaw no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so FreeClaw can keep replying while a provider is rate-limited.
...
Yes. FreeClaw fully supports **OpenAI Code (Codex) subscription OAuth**. The onboarding wizard
...
Gemini CLI uses a **plugin auth flow**, not a client id or secret in `freeclaw.json`.
...
Usually no. FreeClaw needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. FreeClaw runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
### If I buy a Mac mini to run FreeClaw can I connect it to my MacBook Pro
...
### Can multiple people use one WhatsApp number with different FreeClaw instances
...
If you run FreeClaw via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non-login shells.
...
This **does not delete your data** - it only changes the FreeClaw code install. Your state
(`~/.freeclaw`) and workspace (`~/.freeclaw/workspace`) stay untouched.
...
### How important is it to run FreeClaw on a dedicated machine
...
### Can I run FreeClaw in a VM and what are the requirements
...
### What is FreeClaw in one paragraph
...
### Can FreeClaw help with lead gen outreach ads and blogs for a SaaS
...
Claude Code or Codex for the fastest direct coding loop inside a repo. Use FreeClaw when you
...
Showcase: [https://freeclaw.ai/showcase](https://freeclaw.ai/showcase)

## Skills and automation

### How do I customize skills without keeping the repo dirty

Use managed overrides instead of editing the repo copy. Put your changes in `~/.freeclaw/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.freeclaw/freeclaw.json`). Precedence is `<workspace>/skills` > `~/.freeclaw/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.freeclaw/freeclaw.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.freeclaw/skills` → bundled → `skills.load.extraDirs`. `clawhub` installs into `./skills` by default, which FreeClaw treats as `<workspace>/skills`.
...
- Confirm cron is enabled (`cron.enabled`) and `FREECLAW_SKIP_CRON` is not set.
...
### Can FreeClaw run tasks on a schedule or continuously in the background
...
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. FreeClaw can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3. Override the skill metadata (workspace or `~/.freeclaw/skills`) to allow Linux:
...
ClawHub installs into `./skills` under your current directory (or falls back to your configured FreeClaw workspace); FreeClaw treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.freeclaw/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [ClawHub](/tools/clawhub).
...
- Persist `/home/node` with `FREECLAW_HOME_VOLUME` so caches survive.
- Bake system deps into the image with `FREECLAW_DOCKER_APT_PACKAGES`.
...
If you don't set a provider explicitly, FreeClaw auto-selects a provider when it
...
### Where does FreeClaw store its data

Everything lives under `$FREECLAW_STATE_DIR` (default: `~/.freeclaw`):

| Path                                                            | Purpose                                                      |
| --------------------------------------------------------------- | ------------------------------------------------------------ |
| `$FREECLAW_STATE_DIR/freeclaw.json`                             | Main config (JSON5)                                          |
| `$FREECLAW_STATE_DIR/credentials/oauth.json`                    | Legacy OAuth import (copied into auth profiles on first use) |
| `$FREECLAW_STATE_DIR/agents/<agentId>/agent/auth-profiles.json` | Auth profiles (OAuth + API keys)                             |
| `$FREECLAW_STATE_DIR/agents/<agentId>/agent/auth.json`          | Runtime auth cache (managed automatically)                   |
| `$FREECLAW_STATE_DIR/credentials/`                              | Provider state (e.g. `whatsapp/<accountId>/creds.json`)      |
| `$FREECLAW_STATE_DIR/agents/`                                   | Per-agent state (agentDir + sessions)                        |
| `$FREECLAW_STATE_DIR/agents/<agentId>/sessions/`                | Conversation history & state (per agent)                     |
| `$FREECLAW_STATE_DIR/agents/<agentId>/sessions/sessions.json`   | Session metadata (per agent)                                 |

Legacy single-agent path: `~/.freeclaw/agent/*` (migrated by `openclaw doctor`).

Your **workspace** (AGENTS.md, memory files, skills, etc.) is separate and configured via `agents.defaults.workspace` (default: `~/.freeclaw/workspace`).

### Where should AGENTSmd SOULmd USERmd MEMORYmd live

These files live in the **agent workspace**, not `~/.freeclaw`.

- **Workspace (per agent)**: `AGENTS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`,
  `MEMORY.md` (or `memory.md`), `memory/YYYY-MM-DD.md`, optional `HEARTBEAT.md`.
- **State dir (`~/.freeclaw`)**: config, credentials, auth profiles, sessions, logs,
  and shared skills (`~/.freeclaw/skills`).

Default workspace is `~/.freeclaw/workspace`, configurable via:
...
Do **not** commit anything under `~/.freeclaw` (credentials, sessions, tokens).
...
`workspace` to the repo root. The FreeClaw repo is just source code; keep the
...
OpenClaw reads an optional **JSON5** config from `$FREECLAW_CONFIG_PATH` (default: `~/.freeclaw/freeclaw.json`):

```
$FREECLAW_CONFIG_PATH
```

If the file is missing, it uses safe-ish defaults (including a default workspace of `~/.freeclaw/workspace`).

### I set gatewaybind lan or tailnet and now nothing listens the UI says unauthorized

Non-loopback binds **require auth**. Configure `gateway.auth.mode` + `gateway.auth.token` (or use `FREECLAW_GATEWAY_TOKEN`).
...
- Daemons read env vars from `~/.freeclaw/.env` (or the service environment).
...
### Can the FreeClaw browser run headless
...
### Can two FreeClaw instances talk to each other local VPS
...
- Restore from backup (git or a copied `~/.freeclaw/freeclaw.json`).
...
### How does FreeClaw load environment variables
...
1. Put the missing keys in `~/.freeclaw/.env` so they're picked up even when the service doesn't inherit your shell env.
...
does **not** mean your env vars are missing - it just means FreeClaw won't load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won't inherit your shell
environment. Fix by doing one of these:

1. Put the token in `~/.freeclaw/.env`:
...
### Is there a way to make a team of FreeClaw instances one CEO and many agents
...
### How do I completely reset FreeClaw but keep it installed
...
- If you used profiles (`--profile` / `FREECLAW_PROFILE`), reset each state dir (defaults are `~/.freeclaw-<profile>`).
...
headers like `# Heading`), FreeClaw skips the heartbeat run to save API calls.
...
No. FreeClaw runs on **your own account**, so if you're in the group, FreeClaw can see it.
...
### Why doesnt FreeClaw reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.freeclaw/agents/<agentId>/sessions/`.
...
Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-6`). If you omit the provider, FreeClaw currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- edit `agents.defaults.model` in `~/.freeclaw/freeclaw.json`
...
### What do FreeClaw, Flawd, and Krill use for models
...
Yes. FreeClaw ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
Cooldowns apply to failing profiles (exponential backoff), so FreeClaw can keep responding even when a provider is rate-limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.freeclaw/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.freeclaw/agent/*` (migrated by `openclaw doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.freeclaw/.env` or enable `env.shellEnv`.
...
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.freeclaw/.env` on the **gateway host**.
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), FreeClaw will try it during model fallback. If you haven't configured Google credentials, you'll see `No API key found for provider "google"`.
...
Fix: FreeClaw now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
```
--port > FREECLAW_GATEWAY_PORT > gateway.port > default 18789
```

### Why does freeclaw gateway status say Runtime running but RPC probe failed
...
### Why does freeclaw gateway status show Config cli and Config service different

You're editing one config file while the service is running another (often a `--profile` / `FREECLAW_STATE_DIR` mismatch).
...
### How do I run FreeClaw in remote mode client connects to a Gateway elsewhere
...
- Set `gateway.auth.token` (or `FREECLAW_GATEWAY_TOKEN`) on the gateway host.
...
- `FREECLAW_STATE_DIR` (per-instance state)
- `agents.defaults.workspace` (workspace isolation)
- `gateway.port` (unique ports)

Quick setup (recommended):

- Use `openclaw --profile <name> …` per instance (auto-creates `~/.freeclaw-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `openclaw --profile <name> gateway install`.

Profiles also suffix service names (`bot.molt.<profile>`; legacy `com.openclaw.*`, `openclaw-gateway-<profile>.service`, `FreeClaw Gateway (<profile>)`).
...
- macOS: `$FREECLAW_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.freeclaw/logs/...`; profiles use `~/.freeclaw-<profile>/logs/...`)
...
### ELI5 freeclaw gateway restart vs freeclaw gateway
...
### Is it safe to expose FreeClaw to inbound DMs
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. FreeClaw only replies to chats it receives or to explicit sends you trigger.
...
Still stuck? Ask in [Discord](https://discord.com/invite/clawd) or open a [GitHub discussion](https://github.com/freeclaw/freeclaw/discussions).
