...
This guide summarizes a sane workflow for working on the pi integration in FreeClaw.
...
- Trigger the agent directly:
  - `pnpm freeclaw agent --message "Hello" --thinking low`
...
State lives under the FreeClaw state directory. Default is `~/.freeclaw`. If `FREECLAW_STATE_DIR` is set, use that directory instead.

To reset everything:

- `freeclaw.json` for config
...
- [https://docs.freeclaw.ai/testing](https://docs.freeclaw.ai/testing)
- [https://docs.freeclaw.ai/start/getting-started](https://docs.freeclaw.ai/start/getting-started)
