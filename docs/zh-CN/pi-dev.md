...
本指南总结了在 FreeClaw 中开发 Pi 集成的合理工作流程。
...
状态存储在 FreeClaw 状态目录下。默认为 `~/.freeclaw`。如果设置了 `FREECLAW_STATE_DIR`，则使用该目录。
...
- https://docs.freeclaw.ai/testing
- https://docs.freeclaw.ai/start/getting-started
