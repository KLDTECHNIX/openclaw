---
summary: "Schema-accurate configuration examples for common FreeClaw setups"
read_when:
  - Learning how to configure OpenClaw
  - Looking for configuration examples
  - Setting up FreeClaw for the first time
...
Save to `~/.freeclaw/freeclaw.json` and you can DM the bot from that number.
