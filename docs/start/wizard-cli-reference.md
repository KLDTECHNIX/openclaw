...
read_when:
  - You need detailed behavior for freeclaw onboard
...
<Steps>
  <Step title="Existing config detection">
    - If `~/.freeclaw/freeclaw.json` exists, choose Keep, Modify, or Reset.
...
<AccordionGroup>
  ...
  <Accordion title="OpenAI API key">
    ...
    `~/.freeclaw/.env` so launchd can read it.
...
- OAuth credentials: `~/.freeclaw/credentials/oauth.json`
- Auth profiles (API keys + OAuth): `~/.freeclaw/agents/<agentId>/agent/auth-profiles.json`
