...
- Same path: run the app from a fixed location (for FreeClaw, `dist/OpenClaw.app`).
...
Workaround: move files into the FreeClaw workspace (`~/.freeclaw/workspace`) if you want to avoid per-folder grants.
