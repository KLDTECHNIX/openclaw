---
summary: "macOS IPC architecture for FreeClaw app, gateway node transport, and PeekabooBridge"
read_when:
  - Editing IPC contracts or menu bar app IPC
title: "macOS IPC"
---

# FreeClaw macOS IPC architecture
...
- Host preference order (client-side): Peekaboo.app → Claude.app → FreeClaw.app → local execution.
