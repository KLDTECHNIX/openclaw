---
summary: "FreeClaw on Raspberry Pi (budget self-hosted setup)"
read_when:
  - Setting up FreeClaw on a Raspberry Pi
  - Running FreeClaw on ARM devices
  - Building a cheap always-on personal AI
title: "Raspberry Pi"
---

# FreeClaw on Raspberry Pi

## Goal

Run a persistent, always-on FreeClaw Gateway on a Raspberry Pi for **~$35-80** one-time cost (no monthly fees).
...
Most FreeClaw features work on ARM64, but some external binaries may need ARM builds:
