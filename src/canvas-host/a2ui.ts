...
export const A2UI_PATH = "/__freeclaw__/a2ui";

export const CANVAS_HOST_PATH = "/__freeclaw__/canvas";

export const CANVAS_WS_PATH = "/__freeclaw__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.freeclawCanvasA2UIAction.postMessage(...)
  // - Android: window.freeclawCanvasA2UIAction.postMessage(...)
  const handlerNames = ["freeclawCanvasA2UIAction"];
  ...
  globalThis.freeclawPostMessage = postToNode;
  globalThis.freeclawSendUserAction = sendUserAction;
