...
export async function statusCommand(
  ...
  runtime.log(theme.heading("FreeClaw status"));
  runtime.log("");
  ...
  runtime.log(theme.muted(`Full report: ${formatCliCommand("freeclaw security audit")}`));
  runtime.log(theme.muted(`Deep probe: ${formatCliCommand("freeclaw security audit --deep")}`));
  ...
  runtime.log("");
  runtime.log("FAQ: https://docs.freeclaw.ai/faq");
  runtime.log("Troubleshooting: https://docs.freeclaw.ai/troubleshooting");
  runtime.log("");
  ...
  runtime.log(`  Need to share?      ${formatCliCommand("freeclaw status --all")}`);
  runtime.log(`  Need to debug live? ${formatCliCommand("freeclaw logs --follow")}`);
  if (gatewayReachable) {
    runtime.log(`  Need to test channels? ${formatCliCommand("freeclaw status --deep")}`);
  } else {
    runtime.log(`  Fix reachability first: ${formatCliCommand("freeclaw gateway probe")}`);
  }
}
