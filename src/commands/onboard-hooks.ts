...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.freeclaw.ai/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("freeclaw hooks list")}`,
      `  ${formatCliCommand("freeclaw hooks enable <name>")}`,
      `  ${formatCliCommand("freeclaw hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
