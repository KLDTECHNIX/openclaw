...
const SANDBOX_EXAMPLES = {
  main: [
    ["freeclaw sandbox list", "List all sandbox containers."],
    ["freeclaw sandbox list --browser", "List only browser containers."],
    ["freeclaw sandbox recreate --all", "Recreate all containers."],
    ["freeclaw sandbox recreate --session main", "Recreate a specific session."],
    ["freeclaw sandbox recreate --agent mybot", "Recreate agent containers."],
    ["freeclaw sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["freeclaw sandbox list", "List all sandbox containers."],
    ["freeclaw sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["freeclaw sandbox recreate --all", "Recreate all containers."],
    ["freeclaw sandbox recreate --session main", "Recreate a specific session."],
    ["freeclaw sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["freeclaw sandbox recreate --browser --all", "Recreate only browser containers."],
    ["freeclaw sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["freeclaw sandbox explain", "Show effective sandbox config."],
    ["freeclaw sandbox explain --session agent:main:main", "Explain a specific session."],
    ["freeclaw sandbox explain --agent work", "Explain an agent sandbox."],
    ["freeclaw sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.freeclaw.ai/cli/sandbox")}\n`,
    )
    .action(() => {
