...
export const DEFAULT_LOG_DIR = "/tmp/freeclaw";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "freeclaw.log"); // legacy single-file path

const LOG_PREFIX = "freeclaw";
