...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "freeclaw-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveOpenClawPackageRoot } = await import("./freeclaw-root.js");
    ...
    vi.mocked(resolveOpenClawPackageRoot).mockResolvedValue("/opt/freeclaw");
