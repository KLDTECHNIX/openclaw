...
beforeAll(async () => {
  ...
  prevGatewayToken = process.env.FREECLAW_GATEWAY_TOKEN;
  gatewayPort = await getFreePort();
  process.env.FREECLAW_GATEWAY_PORT = String(gatewayPort);
  process.env.FREECLAW_GATEWAY_TOKEN = "test-token";
...
afterAll(async () => {
  ...
  if (prevGatewayToken === undefined) {
    ...
    process.env.FREECLAW_GATEWAY_TOKEN = prevGatewayToken;
  }
});
