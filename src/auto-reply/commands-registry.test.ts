...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@freeclaw", { botUsername: "freeclaw" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@freeclaw args", {
        botUsername: "freeclaw",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@freeclaw: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "freeclaw" })).toBe(
      "/help@otherbot",
    );
  });
