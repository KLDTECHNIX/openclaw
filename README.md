# 🦞 FreeClaw — Personal AI Assistant

<p align="center">
    <picture>
        <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/openclaw/openclaw/main/docs/assets/openclaw-logo-text-dark.png">
        <img src="https://raw.githubusercontent.com/openclaw/openclaw/main/docs/assets/openclaw-logo-text.png" alt="FreeClaw" width="500">
    </picture>
</p>
...
<p align="center">
  <a href="https://github.com/freeclaw/freeclaw/actions/workflows/ci.yml?branch=main"><img src="https://img.shields.io/github/actions/workflow/status/openclaw/openclaw/ci.yml?branch=main&style=for-the-badge" alt="CI status"></a>
  <a href="https://github.com/freeclaw/freeclaw/releases"><img src="https://img.shields.io/github/v/release/openclaw/openclaw?include_prereleases&style=for-the-badge" alt="GitHub release"></a>
...
[Website](https://freeclaw.ai) · [Docs](https://docs.freeclaw.ai) · [DeepWiki](https://deepwiki.com/openclaw/openclaw) · [Getting Started](https://docs.freeclaw.ai/start/getting-started) · [Updating](https://docs.freeclaw.ai/install/updating) · [Showcase](https://docs.freeclaw.ai/start/showcase) · [FAQ](https://docs.freeclaw.ai/start/faq) · [Wizard](https://docs.freeclaw.ai/start/wizard) · [Nix](https://github.com/openclaw/nix-clawdbot) · [Docker](https://docs.freeclaw.ai/install/docker) · [Discord](https://discord.gg/clawd)
...
New install? Start here: [Getting started](https://docs.freeclaw.ai/start/getting-started)
...
Model note: while any model is supported, I strongly recommend **Anthropic Pro/Max (100/200) + Opus 4.6** for long‑context strength and better prompt‑injection resistance. See [Onboarding](https://docs.freeclaw.ai/start/onboarding).

## Models (selection + auth)

- Models config + CLI: [Models](https://docs.freeclaw.ai/concepts/models)
- Auth profile rotation (OAuth vs API keys) + fallbacks: [Model failover](https://docs.freeclaw.ai/concepts/model-failover)
...
Full beginner guide (auth, pairing, channels): [Getting started](https://docs.freeclaw.ai/start/getting-started)
...
# Send a message
freeclaw message send --to +1234567890 --message "Hello from FreeClaw"

# Talk to the assistant (optionally deliver back to any connected channel: WhatsApp/Telegram/Slack/Discord/Google Chat/Signal/iMessage/BlueBubbles/Microsoft Teams/Matrix/Zalo/Zalo Personal/WebChat)
freeclaw agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs.freeclaw.ai/install/updating) (and run `openclaw doctor`).
...
Details: [Development channels](https://docs.freeclaw.ai/install/development-channels).
...
pnpm freeclaw onboard --install-daemon

# Dev loop (auto-reload on TS changes)
pnpm gateway:watch
```

Note: `pnpm freeclaw ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `openclaw` binary.

## Security defaults (DM access)

OpenClaw connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.freeclaw.ai/gateway/security)
...
- **[Local-first Gateway](https://docs.freeclaw.ai/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.freeclaw.ai/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, BlueBubbles (iMessage), iMessage (legacy), Microsoft Teams, Matrix, Zalo, Zalo Personal, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.freeclaw.ai/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.freeclaw.ai/nodes/voicewake) + [Talk Mode](https://docs.freeclaw.ai/nodes/talk)** — always-on speech for macOS/iOS/Android with ElevenLabs.
- **[Live Canvas](https://docs.freeclaw.ai/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.freeclaw.ai/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.freeclaw.ai/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.freeclaw.ai/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.freeclaw.ai/nodes).
- **[Onboarding](https://docs.freeclaw.ai/start/wizard) + [skills](https://docs.freeclaw.ai/tools/skills)** — wizard-driven setup with bundled/managed/workspace skills.
...
- [Gateway WS control plane](https://docs.freeclaw.ai/gateway) with sessions, presence, config, cron, webhooks, [Control UI](https://docs.freeclaw.ai/web), and [Canvas host](https://docs.freeclaw.ai/platforms/mac/canvas#canvas-a2ui).
- [CLI surface](https://docs.freeclaw.ai/tools/agent-send): gateway, agent, send, [wizard](https://docs.freeclaw.ai/start/wizard), and [doctor](https://docs.freeclaw.ai/gateway/doctor).
- [Pi agent runtime](https://docs.freeclaw.ai/concepts/agent) in RPC mode with tool streaming and block streaming.
- [Session model](https://docs.freeclaw.ai/concepts/session): `main` for direct chats, group isolation, activation modes, queue modes, reply-back. Group rules: [Groups](https://docs.freeclaw.ai/concepts/groups).
- [Media pipeline](https://docs.freeclaw.ai/nodes/images): images/audio/video, transcription hooks, size caps, temp file lifecycle. Audio details: [Audio](https://docs.freeclaw.ai/nodes/audio).

### Channels

- [Channels](https://docs.freeclaw.ai/channels): [WhatsApp](https://docs.freeclaw.ai/channels/whatsapp) (Baileys), [Telegram](https://docs.freeclaw.ai/channels/telegram) (grammY), [Slack](https://docs.freeclaw.ai/channels/slack) (Bolt), [Discord](https://docs.freeclaw.ai/channels/discord) (discord.js), [Google Chat](https://docs.freeclaw.ai/channels/googlechat) (Chat API), [Signal](https://docs.freeclaw.ai/channels/signal) (signal-cli), [BlueBubbles](https://docs.freeclaw.ai/channels/bluebubbles) (iMessage, recommended), [iMessage](https://docs.freeclaw.ai/channels/imessage) (legacy imsg), [Microsoft Teams](https://docs.freeclaw.ai/channels/msteams) (extension), [Matrix](https://docs.freeclaw.ai/channels/matrix) (extension), [Zalo](https://docs.freeclaw.ai/channels/zalo) (extension), [Zalo Personal](https://docs.freeclaw.ai/channels/zalouser) (extension), [WebChat](https://docs.freeclaw.ai/web/webchat).
- [Group routing](https://docs.freeclaw.ai/concepts/group-messages): mention gating, reply tags, per-channel chunking and routing. Channel rules: [Channels](https://docs.freeclaw.ai/channels).

### Apps + nodes

- [macOS app](https://docs.freeclaw.ai/platforms/macos): menu bar control plane, [Voice Wake](https://docs.freeclaw.ai/nodes/voicewake)/PTT, [Talk Mode](https://docs.freeclaw.ai/nodes/talk) overlay, [WebChat](https://docs.freeclaw.ai/web/webchat), debug tools, [remote gateway](https://docs.freeclaw.ai/gateway/remote) control.
- [iOS node](https://docs.freeclaw.ai/platforms/ios): [Canvas](https://docs.freeclaw.ai/platforms/mac/canvas), [Voice Wake](https://docs.freeclaw.ai/nodes/voicewake), [Talk Mode](https://docs.freeclaw.ai/nodes/talk), camera, screen recording, Bonjour pairing.
- [Android node](https://docs.freeclaw.ai/platforms/android): [Canvas](https://docs.freeclaw.ai/platforms/mac/canvas), [Talk Mode](https://docs.freeclaw.ai/nodes/talk), camera, screen recording, optional SMS.
- [macOS node mode](https://docs.freeclaw.ai/nodes): system.run/notify + canvas/camera exposure.

### Tools + automation

- [Browser control](https://docs.freeclaw.ai/tools/browser): dedicated freeclaw Chrome/Chromium, snapshots, actions, uploads, profiles.
- [Canvas](https://docs.freeclaw.ai/platforms/mac/canvas): [A2UI](https://docs.freeclaw.ai/platforms/mac/canvas#canvas-a2ui) push/reset, eval, snapshot.
- [Nodes](https://docs.freeclaw.ai/nodes): camera snap/clip, screen record, [location.get](https://docs.freeclaw.ai/nodes/location-command), notifications.
- [Cron + wakeups](https://docs.freeclaw.ai/automation/cron-jobs); [webhooks](https://docs.freeclaw.ai/automation/webhook); [Gmail Pub/Sub](https://docs.freeclaw.ai/automation/gmail-pubsub).
- [Skills platform](https://docs.freeclaw.ai/tools/skills): bundled, managed, and workspace skills with install gating + UI.

### Runtime + safety

- [Channel routing](https://docs.freeclaw.ai/concepts/channel-routing), [retry policy](https://docs.freeclaw.ai/concepts/retry), and [streaming/chunking](https://docs.freeclaw.ai/concepts/streaming).
- [Presence](https://docs.freeclaw.ai/concepts/presence), [typing indicators](https://docs.freeclaw.ai/concepts/typing-indicators), and [usage tracking](https://docs.freeclaw.ai/concepts/usage-tracking).
- [Models](https://docs.freeclaw.ai/concepts/models), [model failover](https://docs.freeclaw.ai/concepts/model-failover), and [session pruning](https://docs.freeclaw.ai/concepts/session-pruning).
- [Security](https://docs.freeclaw.ai/gateway/security) and [troubleshooting](https://docs.freeclaw.ai/channels/troubleshooting).

### Ops + packaging

- [Control UI](https://docs.freeclaw.ai/web) + [WebChat](https://docs.freeclaw.ai/web/webchat) served directly from the Gateway.
- [Tailscale Serve/Funnel](https://docs.freeclaw.ai/gateway/tailscale) or [SSH tunnels](https://docs.freeclaw.ai/gateway/remote) with token/password auth.
- [Nix mode](https://docs.freeclaw.ai/install/nix) for declarative config; [Docker](https://docs.freeclaw.ai/install/docker)-based installs.
- [Doctor](https://docs.freeclaw.ai/gateway/doctor) migrations, [logging](https://docs.freeclaw.ai/logging).
...
- **[Gateway WebSocket network](https://docs.freeclaw.ai/concepts/architecture)** — single WS control plane for clients, tools, and events (plus ops: [Gateway runbook](https://docs.freeclaw.ai/gateway)).
- **[Tailscale exposure](https://docs.freeclaw.ai/gateway/tailscale)** — Serve/Funnel for the Gateway dashboard + WS (remote access: [Remote](https://docs.freeclaw.ai/gateway/remote)).
- **[Browser control](https://docs.freeclaw.ai/tools/browser)** — openclaw‑managed Chrome/Chromium with CDP control.
- **[Canvas + A2UI](https://docs.freeclaw.ai/platforms/mac/canvas)** — agent‑driven visual workspace (A2UI host: [Canvas/A2UI](https://docs.freeclaw.ai/platforms/mac/canvas#canvas-a2ui)).
- **[Voice Wake](https://docs.freeclaw.ai/nodes/voicewake) + [Talk Mode](https://docs.freeclaw.ai/nodes/talk)** — always‑on speech and continuous conversation.
- **[Nodes](https://docs.freeclaw.ai/nodes)** — Canvas, camera snap/clip, screen record, `location.get`, notifications, plus macOS‑only `system.run`/`system.notify`.
...
- `gateway.bind` must stay `loopback` when Serve/Funnel is enabled (FreeClaw enforces this).
- Serve can be forced to require a password by setting `gateway.auth.mode: "password"` or `gateway.auth.allowTailscale: false`.
- Funnel refuses to start unless `gateway.auth.mode: "password"` is set.
- Optional: `gateway.tailscale.resetOnExit` to undo Serve/Funnel on shutdown.

Details: [Tailscale guide](https://docs.freeclaw.ai/gateway/tailscale) · [Web surfaces](https://docs.freeclaw.ai/web)
...
Details: [Remote access](https://docs.freeclaw.ai/gateway/remote) · [Nodes](https://docs.freeclaw.ai/nodes) · [Security](https://docs.freeclaw.ai/gateway/security)
...
Details: [Nodes](https://docs.freeclaw.ai/nodes) · [macOS app](https://docs.freeclaw.ai/platforms/macos) · [Gateway protocol](https://docs.freeclaw.ai/concepts/architecture)
...
Details: [Session tools](https://docs.freeclaw.ai/concepts/session-tool)
...
Runbook: [iOS connect](https://docs.freeclaw.ai/platforms/ios).

### Android node (optional)

- Pairs via the same Bridge + pairing flow as iOS.
- Exposes Canvas, Camera, and Screen capture commands.
- Runbook: [Android connect](https://docs.freeclaw.ai/platforms/android).

## Agent workspace + skills

- Workspace root: `~/.freeclaw/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.freeclaw/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.freeclaw/freeclaw.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.freeclaw.ai/gateway/configuration)
...
Details: [Security guide](https://docs.freeclaw.ai/gateway/security) · [Docker + sandboxing](https://docs.freeclaw.ai/install/docker) · [Sandbox config](https://docs.freeclaw.ai/gateway/configuration)

### [WhatsApp](https://docs.freeclaw.ai/channels/whatsapp)

- Link the device: `pnpm freeclaw channels login` (stores creds in `~/.freeclaw/credentials`).
- Allowlist who can talk to the assistant via `channels.whatsapp.allowFrom`.
- If `channels.whatsapp.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Telegram](https://docs.freeclaw.ai/channels/telegram)
...
### [Slack](https://docs.freeclaw.ai/channels/slack)

- Set `SLACK_BOT_TOKEN` + `SLACK_APP_TOKEN` (or `channels.slack.botToken` + `channels.slack.appToken`).

### [Discord](https://docs.freeclaw.ai/channels/discord)
...
### [Signal](https://docs.freeclaw.ai/channels/signal)

- Requires `signal-cli` and a `channels.signal` config section.

### [BlueBubbles (iMessage)](https://docs.freeclaw.ai/channels/bluebubbles)

- **Recommended** iMessage integration.
- Configure `channels.bluebubbles.serverUrl` + `channels.bluebubbles.password` and a webhook (`channels.bluebubbles.webhookPath`).
- The BlueBubbles server runs on macOS; the Gateway can run on macOS or elsewhere.

### [iMessage (legacy)](https://docs.freeclaw.ai/channels/imessage)

- Legacy macOS-only integration via `imsg` (Messages must be signed in).
- If `channels.imessage.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Microsoft Teams](https://docs.freeclaw.ai/channels/msteams)

- Configure a Teams app + Bot Framework, then add a `msteams` config section.
- Allowlist who can talk via `msteams.allowFrom`; group access via `msteams.groupAllowFrom` or `msteams.groupPolicy: "open"`.

### [WebChat](https://docs.freeclaw.ai/web/webchat)
...
- [Start with the docs index for navigation and “what’s where.”](https://docs.freeclaw.ai)
- [Read the architecture overview for the gateway + protocol model.](https://docs.freeclaw.ai/concepts/architecture)
- [Use the full configuration reference when you need every key and example.](https://docs.freeclaw.ai/gateway/configuration)
- [Run the Gateway by the book with the operational runbook.](https://docs.freeclaw.ai/gateway)
- [Learn how the Control UI/Web surfaces work and how to expose them safely.](https://docs.freeclaw.ai/web)
- [Understand remote access over SSH tunnels or tailnets.](https://docs.freeclaw.ai/gateway/remote)
- [Follow the onboarding wizard flow for a guided setup.](https://docs.freeclaw.ai/start/wizard)
- [Wire external triggers via the webhook surface.](https://docs.freeclaw.ai/automation/webhook)
- [Set up Gmail Pub/Sub triggers.](https://docs.freeclaw.ai/automation/gmail-pubsub)
- [Learn the macOS menu bar companion details.](https://docs.freeclaw.ai/platforms/mac/menu-bar)
- [Platform guides: Windows (WSL2)](https://docs.freeclaw.ai/platforms/windows), [Linux](https://docs.freeclaw.ai/platforms/linux), [macOS](https://docs.freeclaw.ai/platforms/macos), [iOS](https://docs.freeclaw.ai/platforms/ios), [Android](https://docs.freeclaw.ai/platforms/android)
- [Debug common failures with the troubleshooting guide.](https://docs.freeclaw.ai/channels/troubleshooting)
- [Review security guidance before exposing anything.](https://docs.freeclaw.ai/gateway/security)

## Advanced docs (discovery + control)

- [Discovery + transports](https://docs.freeclaw.ai/gateway/discovery)
- [Bonjour/mDNS](https://docs.freeclaw.ai/gateway/bonjour)
- [Gateway pairing](https://docs.freeclaw.ai/gateway/pairing)
- [Remote gateway README](https://docs.freeclaw.ai/gateway/remote-gateway-readme)
- [Control UI](https://docs.freeclaw.ai/web/control-ui)
- [Dashboard](https://docs.freeclaw.ai/web/dashboard)

## Operations & troubleshooting

- [Health checks](https://docs.freeclaw.ai/gateway/health)
- [Gateway lock](https://docs.freeclaw.ai/gateway/gateway-lock)
- [Background process](https://docs.freeclaw.ai/gateway/background-process)
- [Browser troubleshooting (Linux)](https://docs.freeclaw.ai/tools/browser-linux-troubleshooting)
- [Logging](https://docs.freeclaw.ai/logging)

## Deep dives

- [Agent loop](https://docs.freeclaw.ai/concepts/agent-loop)
- [Presence](https://docs.freeclaw.ai/concepts/presence)
- [TypeBox schemas](https://docs.freeclaw.ai/concepts/typebox)
- [RPC adapters](https://docs.freeclaw.ai/reference/rpc)
- [Queue](https://docs.freeclaw.ai/concepts/queue)

## Workspace & skills

- [Skills config](https://docs.freeclaw.ai/tools/skills-config)
- [Default AGENTS](https://docs.freeclaw.ai/reference/AGENTS.default)
- [Templates: AGENTS](https://docs.freeclaw.ai/reference/templates/AGENTS)
- [Templates: BOOTSTRAP](https://docs.freeclaw.ai/reference/templates/BOOTSTRAP)
- [Templates: IDENTITY](https://docs.freeclaw.ai/reference/templates/IDENTITY)
- [Templates: SOUL](https://docs.freeclaw.ai/reference/templates/SOUL)
- [Templates: TOOLS](https://docs.freeclaw.ai/reference/templates/TOOLS)
- [Templates: USER](https://docs.freeclaw.ai/reference/templates/USER)

## Platform internals

- [macOS dev setup](https://docs.freeclaw.ai/platforms/mac/dev-setup)
- [macOS menu bar](https://docs.freeclaw.ai/platforms/mac/menu-bar)
- [macOS voice wake](https://docs.freeclaw.ai/platforms/mac/voicewake)
- [iOS node](https://docs.freeclaw.ai/platforms/ios)
- [Android node](https://docs.freeclaw.ai/platforms/android)
- [Windows (WSL2)](https://docs.freeclaw.ai/platforms/windows)
- [Linux app](https://docs.freeclaw.ai/platforms/linux)

## Email hooks (Gmail)

- [docs.freeclaw.ai/gmail-pubsub](https://docs.freeclaw.ai/automation/gmail-pubsub)
